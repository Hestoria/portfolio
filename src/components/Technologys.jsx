...
const Technologys = () => {
    ...
    return (
        <div className="content" id="Technologys" ref={targetRef}>
            <div className="container md-auto h-full grid grid-cols-3 gap-4 items-center ">
                <p className="col-span-3 text-center items-bottom text-xl md:text-2xl lg:text-3xl text-purple-600 dark:text-purple-50 font-bold py-6 border-b-2 border-purple-600 dark:border-purple-50 uppercase">
                    technologies
                </p>
                {
